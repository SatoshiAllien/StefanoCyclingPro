...
watch_sources = [
    "StefanoCyclingProWatch/Sources/StefanoCyclingProWatchApp.swift",
    "StefanoCyclingProWatch/Sources/WatchContentView.swift",
    "StefanoCyclingProWatch/Sources/WatchPhoneConnectivity.swift",
...
def main() -> None:
    ...
    extra_refs = [
        ...
        f"\t\t{ids['watch_assets']} /* WatchAssets.xcassets */ = {{isa = PBXFileReference; lastKnownFileType = folder.assetcatalog; path = StefanoCyclingProWatch/Assets/WatchAssets.xcassets; sourceTree = \"<group>\"; }};",
